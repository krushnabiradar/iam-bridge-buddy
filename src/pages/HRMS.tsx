    ...
    <div className="container mx-auto py-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex gap-4">
          ...
          <Button 
            onClick={() => navigate('/hrms/departments/new')} 
            disabled={user?.role !== 'admin' && user?.role !== 'hr'}
          >
            Add Department
          </Button>
          <Button 
            onClick={() => navigate('/hrms/positions/new')} 
            disabled={user?.role !== 'admin' && user?.role !== 'hr'}
          >
            Add Position
          </Button>
              ...
              {employeesQuery.isLoading ? (
                ...
                <div className="relative w-full overflow-auto">
                  <table className="w-full caption-bottom text-sm">
                    ...
                    <tbody>
                      {employeesQuery.data.employees.map((employee: any) => (
                        <tr key={employee._id} className="border-b">
                          ...
                          <td className="p-4 align-middle">
                            <Button variant="outline" size="sm" onClick={() => navigate(`/hrms/employees/${employee._id}`)}>
                              View
                            </Button>
                          </td>
                        </tr>
                    ...
                    <tbody>
                      {departmentsQuery.data.departments.map((department: any) => (
                        <tr key={department._id} className="border-b">
                          ...
                          <td className="p-4 align-middle">
                            <Button variant="outline" size="sm" onClick={() => navigate(`/hrms/departments/${department._id}`)}>
                              View
                            </Button>
                          </td>
                        </tr>
                    ...
                    <tbody>
                      {positionsQuery.data.positions.map((position: any) => (
                        <tr key={position._id} className="border-b">
                          ...
                          <td className="p-4 align-middle">
                            <Button variant="outline" size="sm" onClick={() => navigate(`/hrms/positions/${position._id}`)}>
                              View
                            </Button>
                          </td>
                        </tr>
